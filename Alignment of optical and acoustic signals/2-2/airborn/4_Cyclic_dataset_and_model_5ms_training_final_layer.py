...
seted_parameter = {'setted_SFT_path':['SFT_log_0_time_shift_0.001_0','SFT_log_0_time_shift_0.001_5','SFT_log_0_time_shift_0.001_10','SFT_log_0_time_shift_0.001_15','SFT_log_0_time_shift_0.001_20'],
                   ...
                   'setted_batch_size':512,'seted_num_epochs':1000, 'seted_lr':0.08,
                   'setted_loss_and_accuracy_file_name':'Loss_and_accuracy_SFT_log_0_time_shift_0.005_-60_-50_training_final_layer','seted_sample_number/2':250,
...
for cyclic_number in cyclic_array:
	...
	for file_number,png_list_5ms in enumerate(png_list):    #Process time-lapse and sampling data to establish a dataset
		...
		print(model)
		#print(model)
		for param in model.parameters():  #Lock the model gradient and prohibit model parameter updates
			param.requires_grad = False
		model.classifier = nn.Linear(in_features=304, out_features=2, bias=False) #Redefine the final layer of the model to participate in training
		#print(model)
...
#Save the highest validation accuracy for each cycle toExcel
