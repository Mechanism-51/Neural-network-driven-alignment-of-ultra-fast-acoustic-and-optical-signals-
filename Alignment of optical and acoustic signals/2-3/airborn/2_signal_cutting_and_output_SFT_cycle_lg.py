...
setted_parameter = {
                     'cycle_start_number':int(10),'cycle_interval':int(5),'cycle_end_number':int(24),'time_shift_length':0.001,
                     'sorted_number_location':int(4),'origin_data_path':'origin_data',
                     'cutted_signal_time':0.025, 'sampling_frequency':int(2000000),'remove_offset':int(1),'log_process':int(1),'normalization':int(1),
