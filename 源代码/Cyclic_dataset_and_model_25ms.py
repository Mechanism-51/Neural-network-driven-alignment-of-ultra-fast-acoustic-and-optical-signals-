...
seted_parameter = {'setted_SFT_path':'SFT_log_1_time_shift_0.001_0',
                   'setted_img_transform_height':64,'setted_img_transform_width':64,
                   'setted_batch_size':512,'seted_num_epochs':100, 'seted_lr':0.0002,
                   'setted_loss_and_accuracy_file_name':'Loss_and_accuracy_SFT_log_1_time_shift_0.001_0_guang',
                   'setted_start_cycle_number':-86,'setted_end_cycle_number':-26,'seted_sample_number/2':1800,
                  }
label_path =  r'guang_processed_label.xls'
...
for cyclic_number in cyclic_array:
	...
	#处理时移数据和采样数据建立数据集
	prcessed_png_list = png_list[2599+cyclic_number:36199+cyclic_number]
